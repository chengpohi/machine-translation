...
/**
 * Created by chengpohi on 14/02/2017.
 */
public class MTTokenizer extends Tokenizer {
    /**
     ...
     */
    public MTTokenizer(AttributeFactory factory) {
        super(factory);
        init();
    }
    ...
    public final boolean incrementToken() throws IOException {
        ...
        while (true) {
            ...
            if (scanner.yylength() <= maxTokenLength) {
                ...
                typeAtt.setType(MTTokenizer.TOKEN_TYPES[tokenType]);
                return true;
            } else
